...
int L_CM_pictures_withoutZ()
{
  ...
  std::string directory="./results2/";//directory comon for all files
  int n=0;
  ...
  while (std::getline(infile,file))
      ...
      if(hist_file->IsZombie())
	{
      ...
      hL1520massDistZLpi0[n]= (TH1F*)hist_file->Get("hL1520massDistLpi0")->Clone();
      hL1520massFTDistZLpi0[n]= (TH1F*)hist_file->Get("hL1520massFTDistLpi0")->Clone();
      ...
      hDLmassDistZL_L[n]=(TH1F*)hist_file->Get("hDLmassDistL_L")->Clone();
      hDLmassDistZL[n]= (TH1F*)hist_file->Get("hDLmassDistL")->Clone();
      hDLmassFTDistZL[n]= (TH1F*)hist_file->Get("hDLmassFTDistL")->Clone();

      hL1520massDistZLpi0_epep[n]= (TH1F*)hist_file->Get("hL1520massDistLpi0_epep")->Clone();
      hL1520massDistZLpi0_emem[n]= (TH1F*)hist_file->Get("hL1520massDistLpi0_emem")->Clone();

      hDLmassDistZL_epep[n]= (TH1F*)hist_file->Get("hDLmassDistL_epep")->Clone();
      hDLmassDistZL_emem[n]= (TH1F*)hist_file->Get("hDLmassDistL_emem")->Clone();
  ...
  cFinalL1520->cd();
  TH1F* sum_renormalize=renolmalize(hL1520mass_background,5);
  TH1F* CM_background=renolmalize(hL1520mass_sum_CBbackground,5);
  ...
  TH1F* hDLmass_sum_background_re=renolmalize(hDLmass_sum_background,4);
